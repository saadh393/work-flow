// import { ShowTickProp } from "../../../util/interfaces";
export interface NoteProvider {
  id: number | null;
  checked?: boolean;
  note?: string | undefined;
}
interface ShowTickProps {
...
const ShowTick = ({ SavedData, deleteVisible, updateCheck, deleteItem, updateNote }: ShowTickProps) => {
  return (
    <div className='modaltick-wrapper'>
      ...
      {deleteVisible && (
        <svg
          className='deleteSVG'
          onClick={() => deleteItem(SavedData.id)}
          height='427pt'
